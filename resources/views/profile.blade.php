            ...
            <div class="col-md-8 offset-md-2">
                <form action="{{ route('shout.saveprofile') }}" method="POST" class="mt-5 mb-5" enctype="multipart/form-data"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nickname" value="{{ Auth::user()->nickname }}" id="nickname"
                            class="shadow-sm form-control">
                    </div>
                    ...
                    <div class="form-group">
                        <button type="submit" class="shadow-sm btn btn-primary mt-2 float-right pl-5 pr-5"> Update
                        </button>
                    </div>
                </form>
            </div>
